...
_C.MODEL.ROI_RELATION_HEAD.MTM.TRAIN_ENABLED = True
...
_C.MODEL.ROI_RELATION_HEAD.MTM.VISUAL_ADAPTER_ENABLED = True

# SVD-refined triplet text teacher
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_SVD_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_SVD_COMPONENTS = 1
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_ENCODE_CHUNK_SIZE = 1024

# MTM losses
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_NEG_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_NEG_MARGIN = 0.2
_C.MODEL.ROI_RELATION_HEAD.MTM.VISUAL_STRUCTURE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_STRUCTURE_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_WARMUP_ITERS = 0
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_RAMP_ITERS = 1

# SHIP pseudo-novel generator
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_CTX_LEN = 4
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_TEXT_ADAPTER_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_TEXT_ADAPTER_HIDDEN_DIM = 1024
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_TEXT_ADAPTER_DROPOUT = 0.1
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_LOW_RECALL_SAMPLING_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_PSEUDO_RATIO = 0.25
# Difficulty-aware pseudo-base replay
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_BASE_REPLAY_ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_BASE_PSEUDO_RATIO = 0.25
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_BASE_DIFFICULTY_MIX = 0.5
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_BASE_DIFFICULTY_EMA = 0.9
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_BASE_DIFFICULTY_TEMPERATURE = 0.1
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_RECON_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_KL_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_WARMUP_ITERS = 2000
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_RAMP_ITERS = 6000
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_LR = 0.001
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_WEIGHT_DECAY = 0.01

# Inference and crop batching
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.UNION_CROP_CHUNK_SIZE = 128

# Diagnostics
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_INTERVAL = 100
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_FILE = "debug.txt"
