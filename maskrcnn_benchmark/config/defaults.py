...
_C.MODEL.ROI_RELATION_HEAD.MTM.VISUAL_ADAPTER_MODE = "union"
_C.MODEL.ROI_RELATION_HEAD.MTM.VISUAL_ADAPTER_MAX_SCALE = 0.1
...
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_NOVEL_ALIGN_WEIGHT = 0.3
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_VISUAL_TRANSFER_ENABLED = True
