...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRAIN_MODE = "w"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RECON_LOSS_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SPARSITY_WEIGHT = 0.005
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.CLASS_WEIGHT_POWER = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.CLASS_WEIGHT_MIN = 1.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.CLASS_WEIGHT_MAX = 1.0
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.COMMON_LOSS_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RESIDUAL_LOGIT_WEIGHT = 0.45
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_DELTA_SCALE = 0.1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ANCHOR_WEIGHT = 0.005
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ORIGINAL_CLIP_EVAL_WEIGHT = 0.8
