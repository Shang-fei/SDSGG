...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.RECON_LOSS_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.SPARSITY_WEIGHT = 0.005
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.BASIS_DECORR_WEIGHT = 0.001
