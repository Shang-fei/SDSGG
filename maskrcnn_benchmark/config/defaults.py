...
_C.MODEL.ROI_RELATION_HEAD.USE_EDGE_MAP = False
_C.MODEL.ROI_RELATION_HEAD.EDGE_MAP_DIR = ""
_C.MODEL.ROI_RELATION_HEAD.EDGE_MAP_BETA = 0.5
_C.MODEL.ROI_RELATION_HEAD.EDGE_MAP_TRAIN_ONLY = True
_C.MODEL.ROI_RELATION_HEAD.USE_EDGE_ADAPTER = True
_C.MODEL.ROI_RELATION_HEAD.EDGE_DISTILL_WEIGHT = 0.1
...
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK = CN()
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.CONFIG_PATH = "configs/semantic_bank_gaussian.yaml"
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.TAU_BANK = 0.07
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.TAU_CLS = 1.0
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.SIGMA_MIN = 0.06
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.SIGMA_MAX = 0.35
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.LOSS_NLL_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.LOSS_PRIOR_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.LOSS_CLIP_RAW_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.OBJECT_FILTER_WEIGHT = 0.2
