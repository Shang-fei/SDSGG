...
# Evidence-Conditioned Local Relational Geometry Field predictor.
_C.MODEL.ROI_RELATION_HEAD.ELRGF = CN()
_C.MODEL.ROI_RELATION_HEAD.ELRGF.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.ELRGF.METRIC_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.ELRGF.AXIS_DIM = 128
_C.MODEL.ROI_RELATION_HEAD.ELRGF.NUM_AXES = 6
_C.MODEL.ROI_RELATION_HEAD.ELRGF.LOW_RANK = 4
_C.MODEL.ROI_RELATION_HEAD.ELRGF.BASE_LOGIT_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.ELRGF.METRIC_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.ELRGF.FREQ_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.ELRGF.AXIS_LOSS_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.ELRGF.METRIC_REG_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.ELRGF.AXIOM_LOSS_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.ELRGF.AXIS_DROPOUT = 0.2
_C.MODEL.ROI_RELATION_HEAD.ELRGF.DETACH_AXIS = True
_C.MODEL.ROI_RELATION_HEAD.ELRGF.USE_AXIS_PSEUDO_LABELS = True
_C.MODEL.ROI_RELATION_HEAD.ELRGF.CENTER_METRIC_LOGITS = True
_C.MODEL.ROI_RELATION_HEAD.ELRGF.USE_UNION_FEATURES = True
_C.MODEL.ROI_RELATION_HEAD.ELRGF.INIT_PROTOTYPES_FROM_CLASSIFIER = True
_C.MODEL.ROI_RELATION_HEAD.ELRGF.INIT_PROTOTYPES_FROM_TEXT = True
_C.MODEL.ROI_RELATION_HEAD.ELRGF.DISABLE_BG_METRIC = True

# Relation Sparse Autoencoding predictor.
_C.MODEL.ROI_RELATION_HEAD.RESA = CN()
_C.MODEL.ROI_RELATION_HEAD.RESA.ATOM_DIM = 64
_C.MODEL.ROI_RELATION_HEAD.RESA.PAIR_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.RESA.BASE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.RESA.ATOM_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.RESA.FREQ_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.RESA.RECON_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.RESA.SPARSE_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.RESA.DIVERSITY_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.RESA.CONSIST_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.RESA.CONTRAST_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.RESA.INIT_PRED_ATOMS_FROM_TEXT = True
_C.MODEL.ROI_RELATION_HEAD.RESA.USE_UNION_FEATURES = True

# Relational Intervention Program predictor.
_C.MODEL.ROI_RELATION_HEAD.RIP = CN()
_C.MODEL.ROI_RELATION_HEAD.RIP.HIDDEN_DIM = 128
_C.MODEL.ROI_RELATION_HEAD.RIP.OBJ_EMBED_DIM = 64
_C.MODEL.ROI_RELATION_HEAD.RIP.LOGIT_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.RIP.MAX_EDIT = 0.5
_C.MODEL.ROI_RELATION_HEAD.RIP.MARGIN = 0.2
_C.MODEL.ROI_RELATION_HEAD.RIP.HARD_NEG_TOPK = 8
_C.MODEL.ROI_RELATION_HEAD.RIP.DETACH_EVIDENCE = True
_C.MODEL.ROI_RELATION_HEAD.RIP.ENERGY_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.RIP.RANK_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.RIP.CLS_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.RIP.CLS_GAMMA = 2.0
_C.MODEL.ROI_RELATION_HEAD.RIP.SPARSE_WEIGHT = 0.005
_C.MODEL.ROI_RELATION_HEAD.RIP.ANCHOR_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.RIP.DIRECTION_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.RIP.DISTILL_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.RIP.TAIL_WEIGHT_POWER = 0.5

_C.MODEL.ROI_RELATION_HEAD.CREDO = CN()
_C.MODEL.ROI_RELATION_HEAD.CREDO.DEBUG = False
_C.MODEL.ROI_RELATION_HEAD.CREDO.DEBUG_PERIOD = 200
