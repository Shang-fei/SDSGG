...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.PROMPT_JSON = ""
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.FOCAL_GAMMA = 2.0
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.FACTOR_COMP_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.FACTOR_COMP_TAU = 0.5
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DIFF_NEG_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DIFF_NEG_TOPK = 5
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DIFF_NEG_MARGIN = 0.2
