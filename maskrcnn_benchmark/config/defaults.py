...
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_PSEUDO_RATIO = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_RECON_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_KL_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_NOVEL_ALIGN_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_RAMP_ITERS = 2000
