...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_SIMILARITY_TAU = 0.20
...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.FOREGROUND_ONLY_LOSS = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.DEBUG_INTERVAL = 100

_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE = CN()
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.LATENT_DIM = 64
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.HIDDEN_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.RELATION_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.GEOMETRY_DIM = 21
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.RECON_LOSS_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.KL_LOSS_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.FOREGROUND_ONLY = True
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.DEBUG_INTERVAL = 100
_C.MODEL.ROI_RELATION_HEAD.VAE_PROBE.STATS_CSV = ""
