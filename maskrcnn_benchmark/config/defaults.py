...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT = CN()
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.PROMPT_JSON = "/workspace/ccloud/sf/SDSGG/analysis/predicate_factor_descriptions.json"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.PROMPT_FIELD = "core_prompt"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RELATION_TEXT_SOURCE = "decomposed"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.CORE_VISUAL_SOURCE = "mva"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RANK = 16
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.INIT_METHOD = "pca"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRAIN_MODE = "none"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RECON_LOSS_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SPARSITY_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.BASIS_DECORR_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_DECORR_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ADDRESS_ANCHOR_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ADDRESS_GRAPH_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ADDRESS_GRAPH_TOPK = 5
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRAIN_BASIS = False
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.FOCAL_GAMMA = 1.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.FOCAL_ALPHA = 1.0
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.LOSS_TYPE = "predicate_focal"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.CLASSIFIER_TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ADDRESS_LOGIT_WEIGHT = 0.25
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ADDRESS_LOGIT_TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.VISUAL_GATE_SCALE = 0.5
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.COMMON_PROMPT_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.COMMON_PROMPT_SCALE = 0.1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.COMMON_LOSS_WEIGHT = 0.005
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RELATION_QUERY_LAYERS = 2
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RELATION_QUERY_HEADS = 4
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RELATION_QUERY_DROPOUT = 0.1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.VISUAL_TOKEN_LIMIT = 8
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SHARED_W_ADAPTER_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SHARED_W_ADAPTER_SCALE = 0.25
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RESIDUAL_LOGIT_WEIGHT = 0.35
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TEXT_LOGIT_WEIGHT = 0.45
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DELTA_LOGIT_WEIGHT = 0.10
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_LOGIT_WEIGHT = 0.20
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RESIDUAL_ALIGN_WEIGHT = 0.10
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DELTA_TRANSFER_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DELTA_TOPK_ANCHOR = 5
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DELTA_AUX_TOPK = 3
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DELTA_LOSS_WEIGHT = 0.10
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DELTA_DIR_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SEMANTIC_TRANSPORT_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_TOPK_ANCHOR = 5
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_LOSS_WEIGHT = 0.10
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_CYCLE_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_STEP_SCALE = 0.2
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_DELTA_SCALE = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ANCHOR_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.W_ACTIVE_THRESHOLD = 0.05
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.VISUAL_LOWRANK_RESIDUAL_SCALE = 0.2
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ORIGINAL_CLIP_EVAL_WEIGHT = 0.4
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.LOGIT_ADJUSTMENT_TAU = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.DEBUG_INTERVAL = 500
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.BASIS_ALIGN_ALPHA = 2.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.BASIS_ALIGN_BETA = 0.01
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.BASIS_ALIGN_MARGIN = 0.03
