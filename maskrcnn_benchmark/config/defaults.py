...
# Shared soft prompt distribution settings.
...
_C.MODEL.ROI_RELATION_HEAD.MTM.USE_DISTRIBUTION_SAMPLING = True
_C.MODEL.ROI_RELATION_HEAD.MTM.USE_ENTITY_DISTRIBUTION_SAMPLING = False
_C.MODEL.ROI_RELATION_HEAD.MTM.SAMPLE_NUM = 2
_C.MODEL.ROI_RELATION_HEAD.MTM.SAMPLE_GAMMA = 0.1
