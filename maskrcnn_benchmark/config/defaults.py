...
_C.MODEL.ROI_RELATION_HEAD.MTM.BPL_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.BPL_CTX_LEN = 4
_C.MODEL.ROI_RELATION_HEAD.MTM.BPL_SAMPLE_NUM = 2
_C.MODEL.ROI_RELATION_HEAD.MTM.BPL_TEST_SAMPLE_NUM = 4
_C.MODEL.ROI_RELATION_HEAD.MTM.BPL_KL_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.MTM.BPL_INIT_STD = 0.02
_C.MODEL.ROI_RELATION_HEAD.MTM.BPL_SVD_ANCHOR_WEIGHT = 0.1
