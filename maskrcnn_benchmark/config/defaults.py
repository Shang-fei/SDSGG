...
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_WARMUP_ITERS = 500
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_RAMP_ITERS = 2000
...
# Diagnostics
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_INTERVAL = 500
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_FILE = "mtm_debug.txt"
