...
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_DEBUG_ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_DEBUG_STEP = 100
...
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_PSEUDO_RATIO = 0.5
