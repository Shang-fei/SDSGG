...
_C.MODEL.ROI_RELATION_HEAD.MTM.TRAINING_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.MAX_TRAIN_PAIRS = 256

# MTM visual-to-text projector
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.INPUT_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.EMBED_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.NUM_FC_LAYERS = 3
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.NUM_ATTENTION_LAYERS = 3
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.NUM_HEADS = 8
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.DROPOUT = 0.1
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.VISUAL_ADAPTER_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.PROJECTOR.ENTITY_FUSION_ENABLED = False

# SVD-refined triplet text teacher
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_TEACHER = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_TEACHER.SVD_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_TEACHER.NUM_SVD_COMPONENTS = 1
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_TEACHER.ENCODE_BATCH_SIZE = 1024

# MTM losses
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.ALIGNMENT_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.NEGATIVE_ALIGNMENT_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.NEGATIVE_MARGIN = 0.2
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.VISUAL_STRUCTURE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.TEXT_STRUCTURE_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.STRUCTURE_DISTANCE = "l1"
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.STRUCTURE_REFERENCE = "projected"
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.STRUCTURE_WARMUP_STEPS = 0
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS.STRUCTURE_RAMP_STEPS = 1

# SHIP pseudo-novel generator
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.CONTEXT_LENGTH = 4
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.PSEUDO_NOVEL_RATIO = 0.25
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.LOW_RECALL_SAMPLING_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.LOW_RECALL_RELATIONS = (
    "across", "along", "and", "laying on", "mounted on", "on back of",
    "painted on", "part of",
)
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.RECONSTRUCTION_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.KL_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.WARMUP_STEPS = 2000
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.RAMP_STEPS = 6000

_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.TEXT_ADAPTER = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.TEXT_ADAPTER.ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.TEXT_ADAPTER.HIDDEN_DIM = 1024
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.TEXT_ADAPTER.DROPOUT = 0.1

# Difficulty-aware pseudo-base replay
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.BASE_REPLAY = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.BASE_REPLAY.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.BASE_REPLAY.PSEUDO_RATIO = 0.25
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.BASE_REPLAY.DIFFICULTY_MIX = 0.5
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.BASE_REPLAY.DIFFICULTY_EMA = 0.9
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.BASE_REPLAY.DIFFICULTY_TEMPERATURE = 0.1

_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.OPTIMIZER = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.OPTIMIZER.LR = 0.001
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP.OPTIMIZER.WEIGHT_DECAY = 0.01

# Inference and crop batching
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE.ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE.SCORE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE.UNION_CROP_BATCH_SIZE = 128

# Diagnostics
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG.ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG.INTERVAL_STEPS = 100
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG.FILE = "debug.txt"

# Relationness auxiliary branch for pair-level relation existence.
_C.MODEL.ROI_RELATION_HEAD.RELATIONNESS = CN()
_C.MODEL.ROI_RELATION_HEAD.RELATIONNESS.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.RELATIONNESS.LOSS_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.RELATIONNESS.USE_INFERENCE = True
_C.MODEL.ROI_RELATION_HEAD.RELATIONNESS.LOSS_WEIGHT = 1.0
