...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.BASIS_ANCHOR_WEIGHT = 0.01
...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SHIFT_SCALE = 0.1
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_NOISE_SCALE = 0.02
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SHIFT_LOSS_WEIGHT = 0.001
