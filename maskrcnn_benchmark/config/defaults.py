...
_C.MODEL.ROI_RELATION_HEAD.CLIP_MVA_CHUNK_SIZE = 16

# LLM primitive low-rank predicate text decomposition.
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT = CN()
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.JSON_PATH = "predicate_primitives_vg.json"
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.CLASSIFIER_TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.TRAIN_BASIS = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.TRAIN_WEIGHT = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.RECON_LOSS_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.COSINE_RECON_LOSS_WEIGHT = 0.8
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.SPARSITY_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.MASK_OUT_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.BASIS_DECORR_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.WEIGHT_DECORR_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.BASIS_ANCHOR_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_RANK = 4
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_HIDDEN_DIM = 128
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SHIFT_SCALE = 0.2
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_NOISE_SCALE = 0.02
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SHIFT_LOSS_WEIGHT = 0.0005
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_VAR_LOSS_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SAMPLE = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.FOCAL_GAMMA = 1.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.FOCAL_ALPHA = 1.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.CLASS_WEIGHT_POWER = 0.5
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.CLASS_WEIGHT_MIN = 0.25
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.CLASS_WEIGHT_MAX = 4.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DEBUG_LOG_PERIOD = 200
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.USE_OBJECT_FILTER = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.OBJECT_FILTER_WEIGHT = 0.5
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.OBJECT_FILTER_TEMPERATURE = 0.05

# clip_V2 keeps the original ClipPredictor pipeline and adds a lightweight
# W-space reconstruction/distribution branch on top of description_relation.
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2 = CN()
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.TRAIN_W = True
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.TRAIN_BASIS = True
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.LOSS_TYPE = "clip_regression"  # "clip_regression" or "w_align"
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.W_RESIDUAL_SCALE = 0.1
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.RECON_LOSS_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.W_ANCHOR_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.BASIS_ANCHOR_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_HIDDEN_DIM = 128
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_RANK = 4
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_SHIFT_SCALE = 0.15
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_NOISE_SCALE = 0.01
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_SAMPLE = True
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.AUX_LOSS_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_SHIFT_LOSS_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DISTRIBUTION_VAR_LOSS_WEIGHT = 0.0005
_C.MODEL.ROI_RELATION_HEAD.CLIP_V2.DEBUG_LOG_PERIOD = 200
