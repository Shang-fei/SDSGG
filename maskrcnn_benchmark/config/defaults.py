...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RANK = 71
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.INIT_METHOD = "pca"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRAIN_MODE = "w"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RECON_LOSS_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SPARSITY_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.BASIS_DECORR_WEIGHT = 0.001
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_DECORR_WEIGHT = 0.001
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.CLASSIFIER_TEMPERATURE = 0.05
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.FACTOR_COMP_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.FACTOR_COMP_TAU = 0.2
