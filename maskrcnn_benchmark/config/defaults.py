...
# Shared CLIP-text settings for CorePromptClipPredictor and LowRankClipPredictor.
...
# Low-rank predicate text decomposition. The default keeps the PCA semantic
# space fixed and avoids reconstruction losses dominating relation learning.
...
# Optional low-rank visual adapter. These are off by default for clean
# CorePrompt/zero-shot ablations and can be enabled explicitly for LowRank runs.
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.COMMON_LOSS_WEIGHT = 0.0
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SHARED_W_ADAPTER_ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SHARED_W_ADAPTER_SCALE = 0.25
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TEXT_LOGIT_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RESIDUAL_LOGIT_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RESIDUAL_ALIGN_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.VISUAL_LOWRANK_RESIDUAL_SCALE = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.SEMANTIC_TRANSPORT_ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_LOGIT_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_TOPK_ANCHOR = 5
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_LOSS_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TRANSPORT_CYCLE_WEIGHT = 0.0
