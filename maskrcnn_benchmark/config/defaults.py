...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.RANK = 32
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.ROUTER_HIDDEN_DIM = 256
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.GATE_ENTROPY_WEIGHT = 0.0
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.REGION_PROMPT_TOKENS = 1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.UNION_RESIDUAL_INIT = 0.0
