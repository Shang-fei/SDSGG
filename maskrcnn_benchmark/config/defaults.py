...
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.SIGMA_MIN = 0.15
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.SIGMA_MAX = 0.45
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.OBJECT_FILTER_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.EMA_MOMENTUM = 0.95
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.EMA_MIN_COUNT = 8
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.LOSS_CLIP_TEACHER_WEIGHT = 0.005
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.UNION_TEACHER_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.SUBOBJ_TEACHER_WEIGHT = 0.5
_C.MODEL.ROI_RELATION_HEAD.SEMANTIC_BANK.DEBUG_INTERVAL = 100
