...
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.INPUT_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.MTM.EMBED_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.MTM.FC_LAYERS = 3
_C.MODEL.ROI_RELATION_HEAD.MTM.ATTENTION_LAYERS = 3
_C.MODEL.ROI_RELATION_HEAD.MTM.NUM_HEADS = 8
_C.MODEL.ROI_RELATION_HEAD.MTM.DROPOUT = 0.1
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.VISUAL_STRUCTURE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_STRUCTURE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_LOSS_TYPE = "l1"
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_TEMPERATURE = 0.5

# MTM branch switch:
# False keeps the original triplet-level MTM path and old loss keys.
# True enables the factorized entity/relation MTM path with soft prompt distributions.
_C.MODEL.ROI_RELATION_HEAD.MTM.FACTORIZED_ENABLED = False

# Shared soft prompt distribution settings for the factorized MTM path.
_C.MODEL.ROI_RELATION_HEAD.MTM.SOFT_PROMPT_NUM = 4
_C.MODEL.ROI_RELATION_HEAD.MTM.SOFT_PROMPT_CTX_LEN = 4
_C.MODEL.ROI_RELATION_HEAD.MTM.SOFT_PROMPT_INIT_STD = 0.02

# Factorized MTM loss weights. Global MTM.LOSS_WEIGHT / ALIGN_WEIGHT /
# STRUCTURE_WEIGHT still multiply these branch-specific weights.
_C.MODEL.ROI_RELATION_HEAD.MTM.ENTITY_ALIGN_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.REL_ALIGN_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.ENTITY_STRUCTURE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.REL_STRUCTURE_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.PROMPT_ANCHOR_WEIGHT = 0.1

# Triplet teacher composition for relation MTM:
# mu_triplet = normalize(w_s * mu_sub + w_p * mu_pred + w_o * mu_obj).
_C.MODEL.ROI_RELATION_HEAD.MTM.TRIPLET_SUBJECT_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.MTM.TRIPLET_PREDICATE_WEIGHT = 0.6
_C.MODEL.ROI_RELATION_HEAD.MTM.TRIPLET_OBJECT_WEIGHT = 0.2

# Detach switches for stable first-stage factorized MTM training.
_C.MODEL.ROI_RELATION_HEAD.MTM.DETACH_MVA_TEXT = True
_C.MODEL.ROI_RELATION_HEAD.MTM.DETACH_MVA_FEATURE_FOR_MTM = True
_C.MODEL.ROI_RELATION_HEAD.MTM.MAX_PAIRS = 256
_C.MODEL.ROI_RELATION_HEAD.MTM.USE_INFERENCE = True
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG = False
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_TRIPLET_INTERVAL = 100
_C.MODEL.ROI_RELATION_HEAD.MTM.DEBUG_TRIPLET_MAX_SAMPLES = 16
_C.MODEL.ROI_RELATION_HEAD.MTM.PROTOTYPE = CN()
_C.MODEL.ROI_RELATION_HEAD.MTM.PROTOTYPE.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.MTM.PROTOTYPE.WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.MTM.PROTOTYPE.TRANSFER_TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.MTM.PROTOTYPE.MOMENTUM = 0.9
_C.MODEL.ROI_RELATION_HEAD.MTM.PROTOTYPE.MIN_COUNT = 20

# Relationness auxiliary branch for pair-level relation existence.
_C.MODEL.ROI_RELATION_HEAD.RELATIONNESS = CN()
_C.MODEL.ROI_RELATION_HEAD.RELATIONNESS.ENABLED = True
