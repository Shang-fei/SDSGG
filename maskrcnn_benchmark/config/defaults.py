...
_C.MODEL.ROI_RELATION_HEAD.MTM.LOSS_WEIGHT = 0.1
...
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE_MODE = "late"
_C.MODEL.ROI_RELATION_HEAD.MTM.INFERENCE_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.MTM.FILTER_BLEND_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.MTM.SCORE_TEMPERATURE = 0.05
