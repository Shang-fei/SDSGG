...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TEXT_SOURCE = "predicate_name"
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.TEMPLATE = "a photo of {} relation"
...
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ADAPTATION = CN()
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ADAPTATION.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ADAPTATION.BOTTLENECK_DIM = 64
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ADAPTATION.NUM_LAYERS = 1
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ADAPTATION.SCALE = 1.0
_C.MODEL.ROI_RELATION_HEAD.LOW_RANK_TEXT.WEIGHT_ADAPTATION.REG_WEIGHT = 0.01
