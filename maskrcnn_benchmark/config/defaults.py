...
# CLIP text prompts and low-rank predicate decomposition.
...
# The default keeps the PCA semantic space fixed and avoids reconstruction
# losses dominating relation learning.
...
# Foreground predicate focal loss.
