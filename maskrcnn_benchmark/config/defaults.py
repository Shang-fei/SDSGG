...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.BASIS_ANCHOR_WEIGHT = 0.2
...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SHIFT_SCALE = 0.3
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_NOISE_SCALE = 0.02
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SHIFT_LOSS_WEIGHT = 0.0001
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_VAR_LOSS_WEIGHT = 0.00001
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.DISTRIBUTION_SAMPLE = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.NOVEL_DISTRIBUTION_SHIFT_SCALE = 0.05
...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.USE_OBJECT_FILTER = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.OBJECT_FILTER_WEIGHT = 0.5
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_TEXT.NOVEL_OBJECT_FILTER_WEIGHT = 0.2
