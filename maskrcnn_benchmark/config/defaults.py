...
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_LOSS_TYPE = "cosine_neg"
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_NEG_WEIGHT = 0.1
...
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_DEBUG_ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.MTM.STRUCTURE_DEBUG_STEP = 500
...
_C.MODEL.ROI_RELATION_HEAD.MTM.TEXT_SVD_CHUNK_SIZE = 1024
...
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_INIT_STD = 0.02
...
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_PSEUDO_RATIO = 0.3
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_RECON_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_KL_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_VISUAL_TRANSFER_ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_VISUAL_TRANSFER_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_TRANSFER_TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_WARMUP_ITERS = 1000
_C.MODEL.ROI_RELATION_HEAD.MTM.SHIP_RAMP_ITERS = 5000
