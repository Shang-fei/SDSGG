...
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM = CN()
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.CKPT = ""
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.ALPHA = 0.05
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.TEMPERATURE = 1.0
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.CANDIDATE_PART = "total"
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.APPLY_IN_TRAIN = False
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.CROP_BATCH_SIZE = 64
_C.MODEL.ROI_RELATION_HEAD.VISOR_PRISM.PROTOTYPE_BATCH_SIZE = 4096
