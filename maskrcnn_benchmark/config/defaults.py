...
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_LOSS_TYPE = "focal"
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_TEMPERATURE = 1.0
_C.MODEL.ROI_RELATION_HEAD.MTM.ALIGN_FOCAL_GAMMA = 2.0
