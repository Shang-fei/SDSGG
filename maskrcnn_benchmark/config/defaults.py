...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.W_SOURCE = "llm_assignment"
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.B_TRAINABLE = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.NUM_TOPK = 5
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_MIN = 0.08
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_MAX = 0.35
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_POS_INIT_LOW = 0.08
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_POS_INIT_HIGH = 0.15
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_ZERO_INIT_LOW = 0.18
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_ZERO_INIT_HIGH = 0.30
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_NEG_INIT_LOW = 0.08
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_NEG_INIT_HIGH = 0.15
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.PRIOR_POSTERIOR_ALPHA = 0.3
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.EMA_MOMENTUM = 0.95
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.LOSS_PROTO_ALIGN_WEIGHT = 0.10
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.LOSS_TOPK_SPARSE_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.USE_NOVEL_TRANSFER = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.NOVEL_TOPK = 3
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.NOVEL_TAU = 0.20
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.NOVEL_SIGNATURE_WEIGHT = 0.5
