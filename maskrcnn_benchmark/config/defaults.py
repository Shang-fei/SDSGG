...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.W_SOURCE = "reconstruction"
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_RECON_STEPS = 300
...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.VISUAL_ALIGN_WEIGHT = 0.10
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.ORIGIN_REG_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.VISUAL_SPARSE_WEIGHT = 0.001
...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.OBJECT_FILTER_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.USE_OBJECT_FILTER = True
