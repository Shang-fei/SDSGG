...
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK = CN()
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.CONFIG_PATH = "configs/primitive_gaussian.yaml"
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.W_SOURCE = "text_similarity"
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_RECON_STEPS = 0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_RECON_LR = 0.05
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_RECON_TAU = 0.20
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_RECON_DEBUG_INTERVAL = 50
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_SIMILARITY_TOPK = 5
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_SIMILARITY_THRESHOLD = -1.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_RECON_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_SPARSE_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.TEXT_ORTH_WEIGHT = 0.05
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.B_TRAINABLE_TEXT_STAGE = True
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.B_TRAINABLE_VISUAL_STAGE = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_MIN = 0.05
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.SIGMA_MAX = 0.30
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.VISUAL_ALIGN_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.ORIGIN_REG_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.VISUAL_SPARSE_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.VISUAL_ACTIVATION_TAU = 0.20
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.ORIGIN_ACTIVATION_TAU = 0.20
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.COMPOSITION_LOGIT_SCALE = 10.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.OBJECT_FILTER_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.USE_OBJECT_FILTER = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.USE_LOG_VARIANCE = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.USE_COMPOSITION_LOGITS = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.USE_VISUAL_VARIANCE_IN_LOGITS = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.USE_NOVEL_VARIANCE_TRANSFER = False
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.NOVEL_TOPK = 3
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.NOVEL_TAU = 0.20
_C.MODEL.ROI_RELATION_HEAD.PRIMITIVE_BANK.DEBUG_INTERVAL = 100
