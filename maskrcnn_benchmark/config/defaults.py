...
_C.MODEL.ROI_RELATION_HEAD.USE_COMMON_RELATION_PROMPT = False
_C.MODEL.ROI_RELATION_HEAD.COMMON_PROMPT_LENGTH = 4
_C.MODEL.ROI_RELATION_HEAD.COMMON_PROMPT_INIT_STD = 0.02
